    ...
    >
      ...
      >
        ...
        <animated.div className="flex items-center justify-center relative mt-260 mb-20" aria-hidden="true">
          ...
          >
            <animated.svg
              style={{ transform: parallaxProps.xy.interpolate(trans0) }}
          ...
          <animated.div
            style={useSpring({
              to: [{ opacity: 1, transform: "scale(0.95)" }, { transform: "scale(1)" }],
          ...
          >
            ...
            >
              <animated.svg
                style={{ transform: parallaxProps.xy.interpolate(transn1) }}
                xmlns="http://www.w3.org/2000/svg"
                width="45"
                height="45"
              >
          ...
          <animated.div
            ...
            style={useSpring({
              ...
              from: { opacity: 0, transform: "scale(1) translateY(15%) rotate(30deg)" },
          ...
          >
            <animated.div
              style={useSpring({
                transform: `rotate(${scrollY * 0.1}deg) translateY(${scrollY * 0.4}%) translateX(${0.4 *
                  scrollY *
                  -1}%)`,
              })}
            >
              <animated.svg
                style={{ transform: parallaxProps.xy.interpolate(trans1) }}
                xmlns="http://www.w3.org/2000/svg"
                width="130"
                height="78"
              >
          ...
          >
            ...
            >
              <animated.svg
                style={{ transform: parallaxProps.xy.interpolate(transn2) }}
                xmlns="http://www.w3.org/2000/svg"
                width="95"
                height="227"
              >
          ...
          <animated.div
            style={useSpring({
              ...
              from: { opacity: 0, transform: "translateX(30px) rotate(90deg)" },
          ...
          >
            ...
            >
              <animated.svg
                style={{ transform: parallaxProps.xy.interpolate(trans2) }}
                xmlns="http://www.w3.org/2000/svg"
                width="119"
                height="96"
              >
          ...
          <animated.div
            ...
            className={`absolute overflow-hidden`.concat(
              " ",
              css({
                bottom: "18px",
